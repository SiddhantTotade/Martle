...
const ProductCarousel2 = () => {
    ...
    return (
        <div className="w-HeaderSwiper m-auto mt-12 justify-center">
            <Typography fontSize={30} sx={{ color: '#fff', marginLeft: '10px', marginBottom: '5px', letterSpacing: '2px', fontFamily: 'fantasy' }}>Shop by Brands</Typography>
                ...
                <Paper elevation={8} sx={{ width: 270, borderRadius: '5px' }} >
                    <div class="container">
                        <div class="card">
                            <div class="content">
                                <div class="imgBx">
                                    <img className="rounded-full border-2 p-2 border-rose-500" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRg9NjzZjN0NV8LPiNPM7HCeYJj-KkkR2vdKg&usqp=CAU" alt="img" />
                                </div>
                                <div class="contentBx">
